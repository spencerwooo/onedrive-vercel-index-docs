...
You can either start from scratch (which is painstakingly simple) - [Getting started](/docs/getting-started.en), or migrate to this latest version with a new OAuth process.
