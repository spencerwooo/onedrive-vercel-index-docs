...
```
https://drive.spencerwoo.com/api?path=/🎻%20Genshin%20playlist/【原神】胡桃：啊对对对对.mp4&raw=true
```

... can also be written as:

```
https://drive.spencerwoo.com/api/name/【原神】胡桃：啊对对对对.mp4?path=/🎻%20Genshin%20playlist/【原神】胡桃：啊对对对对.mp4&raw=true
```

## Notes

- The parameter `name` can be literally anything and it will not affect the direct link.
- The parameter `path` is the path of the file in the drive, and the parameter `raw` makes the API redirect you to the direct link of the file.
